...
const STATUS_COLORS = {
  accepted: "#FF9800",
  "Reached at Pickup Location": "#000",
  in_transit: "#000",
...
export default function FindRider() {
      ...
      [
        { text: "No", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              setRefreshing(true);
              await axios.post(`https://www.appv2.olyox.com/api/v1/heavy/cancel-parcel/${id}`);
              Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
              navigation.goBack()
              setRefreshing(false);
            } catch (error) {
        ...
        >
          ...
          {driverLocation && currentDestination && (
            <MapViewDirections
              ...
              apikey={settings ? settings?.googleApiKey : GOOGLE_MAPS_API_KEY}
              strokeWidth={4}
              strokeColor="#000"
              lineDashPattern={[0]}
              mode="DRIVING"
  ...
  const renderNoRiderFound = () => (
    <View style={styles.noRiderContainer}>
      {parcelError ? (
        <>
          <MaterialIcons name="error-outline" size={60} color="#000" />
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            >
              <MaterialIcons name="support-agent" size={22} color="#000" style={styles.modalOptionIcon} />
            ...
            >
              <MaterialIcons name="refresh" size={22} color="#000" style={styles.modalOptionIcon} />
