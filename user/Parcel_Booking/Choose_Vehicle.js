...
export default function Choose_Vehicle() {
  ...
  const distance = Number.parseFloat(orderDetails?.distance || 0)
  ...
  const fetchVehicles = async () => {
    try {
      setLoading(true)
      const response = await axios.get("https://www.appv2.olyox.com/api/v1/parcel/all-parcel")
  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.container}>
        <StatusBar barStyle={isIOS ? "dark-content" : "light-content"} backgroundColor="#000" />
                ...
                <View style={styles.vehicleContent}>
                  ...
                  <View style={styles.vehicleInfo}>
                    <View style={styles.vehicleHeader}>
                      ...
                      >
                        <Info size={14} color={isSelected ? "#000" : "#999"} />
                      </TouchableOpacity>
                    </View>
