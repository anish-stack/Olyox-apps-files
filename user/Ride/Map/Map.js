...
const GOOGLE_MAPS_APIKEY = 'AIzaSyBfRHuTByG6CiXtLbyzK_aKNpJfDiB4jUo'; // Replace with your key
        ...
        if (Platform.OS === 'ios' && origin && destination) {
            const fetchDirections = async () => {
                try {
                    ...
                    const response = await axios.post('https://www.appv2.olyox.com/directions', { pickup, dropoff });
